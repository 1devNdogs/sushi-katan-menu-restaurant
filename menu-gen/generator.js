...
for(var i in obj)
{
    ...
    */
     ...
     var ingredientsFiltered = cat + ' ' + menuType + ' ' + ingredients.replace(/\,/g,' ')
     ...
     var uniqueList=ingredientsFiltered.split(' ').filter(function(item,i,allItems){
     ...
     if(id ==98 || id == 99){
        ...
        fileContent = fileContent + '<li class="mix '+ uniqueList +' stats-container">\n' +
